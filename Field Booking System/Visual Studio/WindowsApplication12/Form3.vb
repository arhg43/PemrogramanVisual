    ...
    Private Sub btnUbah_Click(sender As Object, e As EventArgs) Handles btnUbah.Click
        ...
        Try
            ...
            If rd.Read() Then
                ...
                Dim tanggalBaru As String = Format(dtpTanggal.Value, "yyyy-MM-dd") ' DateTimePicker selalu punya nilai
                ...
                Dim ubah As String = "UPDATE pemesanan SET no_telepon = @telepon, email = @email, tanggal = @tanggal, " &
                    "jam_mulai = @jam_mulai, jam_selesai = @jam_selesai, lapangan = @lapangan, total_harga = @total_harga " &
                    "WHERE nama = @nama"
                ...
                cmdUbah.Parameters.AddWithValue("@lapangan", lapanganBaru)
