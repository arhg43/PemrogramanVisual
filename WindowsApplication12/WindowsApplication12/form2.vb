...
Public Class Form2
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ' Isi pilihan status ke ComboBox status
        cbmStatus.Items.Clear()
        cbmStatus.Items.Add("Menunggu")
        cbmStatus.Items.Add("Berhasil")
        cbmStatus.SelectedIndex = 0 ' Default: Menunggu
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@status", cbmStatus.Text)
            cmd.ExecuteNonQuery()
    ...
    ' Menuju Form3 untuk ubah data
    Private Sub btnUbah_Click(sender As Object, e As EventArgs) Handles btnUbah.Click
        Form3.Show()
        Me.Hide()
    End Sub

    ' Menuju Form4 untuk lihat/hapus data
